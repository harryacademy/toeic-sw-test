...
- GitHub repo not created yet; build locally with git, push when owner creates it.

## Project location
- Project root: `E:\Claude\SW` (separate from the poster-site repo). Not yet a git repo; GitHub repo name/account TBD.
